...
public class DatabaseMainActivity extends AppCompatActivity {
        ...
        button.setOnClickListener(
                new View.OnClickListener(){
                    ...
                    public void onClick(View v){
                        ...
                        //boolean for : if value is inputed = ture otherwise false)
                        ...
                        if (isInserted==true) {
                            Toast.makeText(DatabaseMainActivity.this, "Data Inserted", Toast.LENGTH_LONG).show();
                            // If data are insert is successful
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_main_activities, menu);
        return true;
    }
